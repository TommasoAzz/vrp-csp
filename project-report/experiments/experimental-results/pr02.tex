...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\columnwidth]{../graphs/pr02-failures.png}
    \caption{Failures graph for pr02.}
\end{figure}
{
\renewcommand{\arraystretch}{2}
\begin{longtable}[h]{| c | c | c | c | c |}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\columnwidth]{../graphs/pr02-objf.png}
    \caption{Objective functions graph for pr02.}
\end{figure}
{
\renewcommand{\arraystretch}{2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\columnwidth]{../graphs/pr02-wobjf.png}
    \caption{Weighted objective functions graph for pr02.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\columnwidth]{../graphs/pr02-distance.png}
    \caption{Distances graph for pr02.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\columnwidth]{../graphs/pr02-vehicles.png}
    \caption{Vehicles used graph for pr02.}
\end{figure}
