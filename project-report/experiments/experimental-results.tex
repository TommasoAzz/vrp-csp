...
After collecting this kind of data and having understood which kind of search strategy suited best, we executed again all the instances with the \textbf{weighted objective function}\footnote{That is objective function (18) presented in Section §2.4.2.}, with \textbf{5 weights combinations}, employing only the best search strategy we had found for both the number of failures and the objective function value.
